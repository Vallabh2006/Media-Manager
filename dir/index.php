    ...
    <div class="app-container" id="appContainer">
        ...
        <main class="view-section active" id="view-landing">
            ...
            <section class="hero-section">
                <span class="hero-badge">CVM University Subject Resource Portal</span>
                <p class="hero-subtitle">A centralized platform for accessing course syllabus, unit-wise notes, presentations, lab practicals, and essential AI learning resources.</p>
            </section>

            <section class="section">
                <div class="grid-3">

                    <div class="card card-clickable" onclick="showView('library.php')">
                        <div class="card-icon"><i data-lucide="book-open"></i></div>
                        <h3>Explore Library</h3>
                        <p>View the 6 comprehensive units of Artificial Intelligence.</p>
                    </div>

                    <div class="card card-clickable" onclick="showView('features.php')">
                        <div class="card-icon"><i data-lucide="sparkles"></i></div>
                        <h3>Key Portal Features</h3>
                        <p>Check out core platform functionalities and features.</p>
                    </div>

                    <div class="card card-clickable" onclick="showView('contacts.php')">
                        <div class="card-icon"><i data-lucide="mail"></i></div>
                        <h3>Get in Touch</h3>
                        <p>Contact support or reach out for academic inquiries.</p>
                    </div>
